...
- Imperative security-affecting text ("ignore instructions", "run command", "install X", "export all")
- Any text attempting to change instruction hierarchy or bypass confirmation
