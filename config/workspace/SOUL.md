...
- Use the QA skill located at `/app/skills/test-specialist` inside the container.
...
Always apply the AAA (Arrange-Act-Assert) pattern for unit tests and follow a structured bug analysis process. You have access to the `test-specialist` skill to help with your tasks.
