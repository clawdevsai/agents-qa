...
This skill is restricted to project work inside `/home/node/.openclaw/projects` only.

- You may read agent context files in `/home/node/.openclaw/workspace` when required by startup/session rules.
- Only write, execute, and modify project files within `/home/node/.openclaw/projects`.
- Refuse operations that target paths outside `/home/node/.openclaw/projects`.
