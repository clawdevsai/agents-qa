...
This skill is restricted to project work inside `/home/node/.openclaw/projects`.

- You may read context files in `/home/node/.openclaw/workspace` only when startup/session rules require it.
- Only modify, execute, and verify files within `/home/node/.openclaw/projects`.
