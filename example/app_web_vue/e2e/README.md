...
1. Na raiz de `app_web_vue_playwright`, instale o runner de testes:
...
4. Garanta que o servidor esta no ar antes dos testes (script `webServer` no config do Playwright com `npm run dev` ou `npm run build && npm start`).
